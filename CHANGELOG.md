...
### Released
- Published **identity-lifecycle-workbench** as a public, portfolio-grade identity governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **identity-lifecycle-workbench**.
- Standardized the core objects, decision surfaces, and operator outputs around the repo's main working problem.
- Established the first reviewable version of the architecture described as: React + TypeScript workbench for joiner-mover-leaver workflows, certification pressure, orphaned-account cleanup, and identity lifecycle visibility.
...
- That insight became the basis for **identity-lifecycle-workbench**.
